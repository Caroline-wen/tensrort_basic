...
if __name__ == '__main__':
    ...
    scale_max = scale_cal(data_float32)
    scale_hist = histgram_range(data_float32)
    print("scale_max: ", scale_max)
    print("scale_hist: ", scale_hist)
    exit(1)
    xq = quant_float_data(data_float32, scale_max)
    print("quant resault: ", xq )
    xdq = dequant_data(xq, scale_max)
    print("dequant resault: ", xdq)
